...
class TestReMarkableNotebook:
    ...
    def test_add_line_to_layer(self):
        ...
        line = notebook.add_line_to_layer(
            layer, points, color=si.PenColor.RED, tool=si.Pen.BALLPOINT_2
        )
...
class TestIntegration:
    ...
    def test_full_workflow(self):
        ...
        points = [
            ...
            si.Point(
                x=0, y=0, speed=0, direction=0, width=1, pressure=50
            ),  # Close rectangle
        ]
        notebook.add_line_to_layer(layer1, points)  # Rectangle in background
        notebook.create_triangle(
            layer2, center_x=100, center_y=100, size=60
        )  # Triangle in drawings
...
class TestWriteMethod:
    ...
    def test_write_creates_file_like_triangel(self, tmp_path):
        ...
        notebook.create_triangle(layer, center_x=200.0, center_y=200.0, size=300.0)
